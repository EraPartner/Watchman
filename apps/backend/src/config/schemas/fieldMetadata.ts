...
const COMMON_FIELDS: ReadonlyArray<FieldMeta> = [
  {
    ...
    required: true,
    default: "main",
    help: "Unique identifier for this instance within the kind.",
  },
...
export const KIND_META: Record<ServiceKind, KindMeta> = {
  ...
  router: {
    ...
    fields: withCommon([
      ...
      },
      {
        ...
        label: "Ports",
        type: "numberArray",
        help: "Optional list of TCP ports to probe.",
      },
      { name: "pingCount", label: "Ping count", type: "number", default: 1 },
      {
        ...
        secret: true,
        placeholder: "public",
        help: "SNMP v2c community string (enables SNMP stats when set).",
      },
      {
        name: "interfaceFilter",
        label: "Interface filter",
        type: "stringArray",
        help: "Restrict interface stats to these names (e.g. eth0). Empty = all.",
      },
    ]),
  ...
  philipsBridge: {
    ...
    description:
      "Philips Hue bridge via Hue API v2 with optional cert pinning.",
    ...
    fields: withCommon([
      ...
      { name: "usePing", label: "Use ping", type: "boolean", default: true },
      {
        ...
        type: "password",
        secret: true,
        help: "Hue API v2 application key (enables light stats).",
      },
      {
        name: "certHash",
        label: "Cert SHA-256",
        type: "text",
        help: "SHA-256 fingerprint of bridge TLS cert for pinning (hex or colon-hex).",
      },
    ]),
  ...
  albyHub: {
    ...
    label: "Alby Hub",
    description:
      "Alby Hub Lightning service. Probes legacy candidate paths by default; switch to NWC for deterministic /api/info + /api/apps polling.",
  ...
  tor: {
    ...
    label: "Tor Relay",
    description:
      "Tor relay via Onionoo (default) or local ControlPort with automatic Onionoo fallback when off-LAN.",
  ...
  bitcoin: {
    ...
    fields: withCommon([
      ...
      {
        name: "zmqHashblockEndpoint",
        label: "ZMQ hashblock endpoint",
        type: "url",
        placeholder: "tcp://127.0.0.1:28332",
      },
      {
        name: "zmqRawtxEndpoint",
        label: "ZMQ rawtx endpoint",
        type: "url",
  ...
  synology: {
    ...
    fields: withCommon([
      ...
      },
      {
        ...
        label: "DSM URL",
        type: "url",
        help: "Synology DSM URL for extended stats (e.g. https://nas.local:5001). Optional.",
      },
  ...
  homebridge: {
    ...
    fields: withCommon([
      ...
      },
      {
        ...
        label: "Status path",
        type: "text",
        default: "/api/status/server-information",
      },
      {
        name: "versionPath",
        label: "Version path",
        type: "text",
        default: "/api/status/homebridge-version",
      },
      {
        name: "loginPath",
        label: "Login path",
  ...
  raspberryPi: {
    ...
    label: "Raspberry Pi",
    description:
      "Raspberry Pi via pigpio + direct SSH or legacy Mac Mini relay.",
    ...
    fields: withCommon([
      ...
      { name: "port", label: "Agent port", type: "number", default: 8888 },
      {
        ...
        label: "SSH user",
        type: "text",
        help: "Direct SSH to Pi (preferred). Enables vcgencmd + /proc stats.",
      },
      { name: "sshPort", label: "SSH port", type: "number", default: 22 },
      { name: "sshKeyPath", label: "SSH key path", type: "text" },
      {
      ...
      },
      {
        ...
        label: "Mac Mini host",
        type: "text",
        help: "Legacy relay. Used only when direct SSH not configured.",
      },
      {
        name: "macMiniSshPort",
        label: "Mac Mini SSH port",
        type: "number",
        default: 22,
      },
      { name: "macMiniSshUser", label: "Mac Mini SSH user", type: "text" },
      {
        name: "macMiniSshKeyPath",
        label: "Mac Mini SSH key path",
        type: "text",
      },
      {
        name: "macMiniSshPassphrase",
        label: "Mac Mini SSH passphrase",
        type: "password",
        secret: true,
      },
      {
...
export const SERVICE_KINDS: ReadonlyArray<ServiceKind> = Object.keys(
  KIND_META
) as ServiceKind[];
